...
print(knitr::kable(acc_tab, format = 'latex'))
# Separate the two columns with an `&`
cat('&')
print(knitr::kable(conf_tab, format = 'latex'))
cat('\\end{tabular}')
cat('\\\\Table: {Accuracy and AUC table (left) and confusion matrix (right, columns are actual).}')
cat('\\end{center}')
